    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          >
            {isFormVisible ? "Cancel" : <>Add New Project <FaPlus className="ml-2" /></>}
          </button>
        </div>
        ...
        {isFormVisible && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-8 transform transition-all duration-300">
            <h2 className="text-xl font-semibold mb-6 text-gray-700 border-b pb-2">Add a New Project</h2>
            {error && (
                      ...
                      <td className="py-4 px-4 relative">
                        ...
                        {dropdownIndex === index && (
                          <div className="absolute right-4 top-12 bg-white shadow-xl rounded-md py-1 w-40 z-10 border">
                            <button className="flex items-center gap-2 px-4 py-2 text-blue-600 hover:bg-blue-50 w-full text-left">
